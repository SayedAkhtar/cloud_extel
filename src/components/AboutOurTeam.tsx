...
export default function AboutOurTeam() {
  ...
  function openModal(index: number) {
    if(index < 0 || index > teamData.length - 1) return;
    if(teamData[index] !== undefined){
        setModalData(teamData[index]);
        setIsOpen(true);
    }
  }
              ...
              >
                <div className="bg-white  max-h-[516px] h-full overflow-hidden md:px-[56px] md:py-[56px] sm:p-6 sm:pb-4">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M0.686523 1.68652L23.3139 24.3139"
                        stroke="#7B8897"
                      />
                      <path
                        d="M0.686523 23.314L23.3139 0.686548"
                        stroke="#7B8897"
                      />
                    </svg>
                  </button>
                  <div className="sm:flex sm:items-start ">
                    <div className="mx-auto flex ">
                      <img
                        src={"/images/about-us/our-team/"+_.capitalize(modalData.name.split(" ")[0])+".png"}
                      ...
                      <div className="mt-8 overflow-y-scroll max-h-[360px] no-scrollbar">
                        {
                            modalData.details.map((detail, index) => (
                                <p className="text-sm mb-4" key={index}>{detail}</p>
                            ))
                        }
                      </div>
                    </div>
